...
describe('propertyService', () => {
  ...
  describe('getProperties', () => {
    ...
    it('fetches properties with name filter', async () => {
      ...
      await propertyService.getProperties({ name: 'Villa' });
    ...
    it('fetches properties with address filter', async () => {
      ...
      await propertyService.getProperties({ address: 'Main St' });
    ...
    it('fetches properties with price range filters', async () => {
      ...
      await propertyService.getProperties({ minPrice: 100000, maxPrice: 500000 });
  ...
  describe('getPropertyById', () => {
    ...
    it('handles property not found', async () => {
      ...
      await expect(propertyService.getPropertyById('nonexistent')).rejects.toMatchObject({
        response: { status: 404 },
      });
    });
    ...
    it('handles network errors', async () => {
      ...
      await expect(propertyService.getPropertyById('1')).rejects.toThrow(errorMessage);
    });
    ...
    it('calls API with correct property id', async () => {
      ...
      await propertyService.getPropertyById(testId);
    ...
    it('handles special characters in property id', async () => {
      ...
      await propertyService.getPropertyById(specialId);
